import svgPaths from "./svg-0zxyqrbfdw";
...
function StateLayer1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[11px] relative rounded-[100px] shrink-0" data-name="state-layer">
      <div className="bg-[#1292c8] rounded-[2px] shrink-0 size-[18px]" data-name="container" />
...
function Filled() {
  return <div className="-translate-y-1/2 absolute bg-[#1292c8] h-[4px] left-0 right-[86.43%] rounded-[100px] top-1/2" data-name="Filled" />;
}
...
export default function JuliannaCreateAcc() {
  return (
    <div className="bg-[#eaeaea] relative size-full" data-name="julianna - create acc">
      ...
      <p className="absolute font-['Baskervville:SemiBold',sans-serif] font-semibold leading-[normal] left-[55px] text-[10px] text-black top-[223px] whitespace-nowrap">Choose up to #</p>
      <p className="absolute font-['Baskervville:Bold',sans-serif] font-bold leading-[normal] left-[57px] text-[#1e1e1e] text-[20px] top-[167px] w-[279px]">What tasks are you interested in?</p>
      ...
      <div className="absolute content-stretch flex flex-col items-center justify-center left-[55px] p-[4px] size-[30px] top-[248px]" data-name="Checkboxes">
        <StateLayer />
      </div>
      <div className="absolute content-stretch flex flex-col items-center justify-center left-[55px] p-[4px] size-[30px] top-[283px]" data-name="Checkboxes">
        <StateLayer1 />
      </div>
      <p className="absolute font-['Baskervville:Bold',sans-serif] font-bold leading-[normal] left-[90px] text-[12px] text-black top-[290px] whitespace-nowrap">Signing a petition</p>
      <p className="absolute font-['Baskervville:Bold',sans-serif] font-bold leading-[normal] left-[90px] text-[12px] text-black top-[255px] whitespace-nowrap">Going to a city council meeting</p>
